...
public class BackgroundTrack extends Track {
    ...
    public BackgroundTrack(String name, Instrument instrument, int channel, int velocity, int lowestOctave, int highestOctave)
    {
